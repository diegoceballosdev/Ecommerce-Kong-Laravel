...
<body class="font-sans antialiased" x-data="{
    ...
    {{-- md:ml-64 INDICA QUE DEL ANCHO md EN ADELANTE EL CUERPO CON TABLAS, BREADCRUM ETC, TENDRA UN MARGEN IZQ DE 64,
    PARA QUE ALLI SE UBIQUE EL SIDEBAR--}}
    ...
    {{-- IMPORTAMOS los scripts de livewire antes de la escucha de eventos de livewire --}}
    @livewireScripts
