<div>
    ...
    <div class="flex items-center space-x-2">
        <input wire:model.live="search" id="search" type="text"
            placeholder="Buscar por ID, SKU, Nombre, Familia, Categoria o Subcategoria"
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-700">
                ...
                <thead class="text-xs text-white uppercase bg-gradient-to-tl from-blue-900 to-gray-900">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">
                            <div class="flex items-center space-x-2">
                                <button wire:click="sortBy('sku')" class="uppercase ">
                                    SKU
                                </button>
                                <x-sort-icon field='sku' :sortField="$sortField" :sortAsc="$sortAsc" />
                            </div>
                        </th>
                        <th scope="col" class="px-6 py-3">
                            <div class="flex items-center space-x-2">
                        ...
                        <th scope="col" class="px-6 py-3">
                            <div class="flex items-center space-x-2">
                                <button wire:click="sortBy('price')" class="uppercase ">
                                    Precio
                                </button>
                ...
                <tbody>
                    ...
                    @foreach ($products as $product)
                        {{-- Fila del producto (efecto cebra con hover) --}}
                        <tr
