<div>
    {{-- buscador --}}
    <div>
        <input wire:model.live="search" id="search" type="text" placeholder="Buscar por ID, Nombre, Familia o Categoria"
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-700">
                ...
                <tbody>
                    ...
                    @foreach ($subcategories as $subcategory)
                        {{-- Fila de la subcategoría (efecto cebra con hover) --}}
                        <tr
    ...
    @else
        ...
        <div class="flex items-center p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
            ...
            <div>
                <span class="font-medium">¡Alerta!</span> Todavia no hay subcategorías registradas.
            </div>
        </div>
