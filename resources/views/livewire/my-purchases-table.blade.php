                    ...
                    @foreach ($orders as $order)
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4 text-gray-800 dark:text-gray-300">
                                {{-- Icono de PDF - se mantiene el estilo del botón, aunque la imagen no tiene clases
                                Tailwind aquí --}}
                            ...
                            {{-- Estado - Aplicando colores semánticos (por ejemplo, verde para Shipped, rojo para
                            Cancelled/Failed) --}}
