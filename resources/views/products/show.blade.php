<x-app-layout>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{route('categories.show', $product->subcategory)}}"
                            class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">
    ...
    <x-container>
        <div class="card mb-12">
            <div class="grid md:grid-cols-2 gap-6 border-b pb-4 mb-4 border-gray-200 dark:border-gray-700">

                <div class="col-span-1">

                    <figure>
                        <img src="{{ $product->image }}"
                            class="aspect-[1/1] w-full object-cover object-center rounded-xl shadow-lg" alt="">
                    </figure>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pb-8">
                <div class="text-base text-gray-600 dark:text-gray-400 mt-6 ">
